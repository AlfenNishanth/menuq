        ...
        <div className="lg:col-span-2">
          <div className="bg-white backdrop-blur-md rounded-xl shadow-lg border border-amber-100 p-8 relative overflow-hidden transform hover:-translate-y-2 transition-all duration-300">
            ...
            <div className="space-y-3">
              ...
              <a href="#Reach Us" className="inline-flex items-center justify-center w-full px-8 py-4 text-lg font-medium text-amber-700 bg-transparent border border-amber-600 rounded-md hover:bg-amber-50 transition-colors duration-300">
